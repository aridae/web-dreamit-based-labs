...
type Repository interface {
	...
	GetRoomCalendarById(roomId int64) ([]models.Event, error)
	GetRoomScheduleByIdAndDate(roomId int64, date time.Time) (*models.Schedule, error)
	UpdateRoomBookingById(roomId int64, event models.Event) error
